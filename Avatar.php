 ...
 * @ORM\Entity(repositoryClass="Potogan\TestBundle\Repository\AvatarRepository")
...
class Avatar
{
    ...
    // On moidifie le setter du File, pour prendre en compte l'upload d'un fichier 
    // lorsqu'il en existe déjà un autre 
    public function setfile(UploadedFile $file)
    {
        $this->file = $file;

        // On vérifie si on vait déjà un fichier pour cette entité 
        if (null !== $this->url ) {
